...
```{error}
If connection issues persist follow steps to [Connect your Apple Watch to a cellular network](../how-to/apple-watch/connect-your-apple-watch-to-a-cellular-network.md)
